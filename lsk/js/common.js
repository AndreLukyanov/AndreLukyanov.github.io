...
//# sourceMappingURL=jquery.viewportchecker.min.js.map
  ...
  var $hamburger = $(".hamburger");
      ...
      $("#head_phone").mask("+38(099) 999-99-99", {autoclear: 0});
      $("#work_phone").mask("+38(099) 999-99-99", {autoclear: 0});
      $("#question_phone").mask("+38(099) 999-99-99");


      /*function form__input() {
      	var input_sibling = $(this).parent().siblings('div').children('input');
      	if($(this).val() == ''){
      		$(this).removeClass('active');
      		$(this).addClass('input-alert');
      		$(this).parent().siblings('.button').prop("disabled", true);
      	}else if($(this).val().search('_') != -1){
      		$(this).addClass('input-alert');
      		$(this).parent().siblings('.button').prop("disabled", true);
      	}else if(input_sibling.val() == '' || input_sibling.val().search('_') != -1){
      		input_sibling.addClass('input-alert');
      		$(this).removeClass('input-alert');
      		$(this).addClass('input-ok');
      		$(this).parent().siblings('.button').prop("disabled", true);
      	}else{
      		$(this).removeClass('input-alert');
      		input_sibling.removeClass('input-alert');
      		$(this).addClass('input-ok');
      		$(this).parent().siblings('.button').prop("disabled", false);
      	}
      }

      function form__button() {
      	if(button_inputs.val() == '' || button_inputs.val().search('_') != -1){
      		$('#work_phone').removeClass('active');
      	}
      }
      document.getElementById("first").onblur=form__input;
      document.getElementById("second").onblur=form__input;
      document.getElementById("head_phone").onblur=form__input;
      document.getElementById("work_phone").onblur=form__input;

      $('form .button').on('click', function(){
      	var button_inputs = $(this).siblings().children('input[type="text"]');
      	var button = $(this);
      	if (button_inputs.val() == '') {
      		setTimeout(function() {button.prop("disabled", true) }, 100);
      	}
      });
      ...
      function form__send(){
      	...
      	$('form.visible input[type="text"]').removeClass('active input-ok');
      	$('form.visible input[type="text"]').val('');
  ...
  function show_magic() {
    jQuery('.hero__title').addClass('animated_visible');
    jQuery('.button button_hero').addClass('animated_visible');
    jQuery('.phone').addClass('animated_visible')
  }
  ...
  particlesJS("particles-js", {"particles":{"number":{"value":80,"density":{"enable":true,"value_area":800}},"color":{"value":"#10b672"},"shape":{"type":"circle","stroke":{"width":0,"color":"#10b672"},"polygon":{"nb_sides":5},"image":{"src":"img/github.svg","width":100,"height":100}},"opacity":{"value":0.5,"random":false,"anim":{"enable":false,"speed":1,"opacity_min":0.1,"sync":false}},"size":{"value":3,"random":true,"anim":{"enable":false,"speed":40,"size_min":0.1,"sync":false}},"line_linked":{"enable":true,"distance":150,"color":"#10b672","opacity":0.4,"width":1},"move":{"enable":true,"speed":2
